	...
	public static void main(String[] args) {
		...
		try {
			...
			PowerConsumptionDTO dto15 = new PowerConsumptionDTO(15, 170D, 7D, LocalDate.of(2022, 05, 15), 100D, "Sujay",
					"MESCOM");
			PowerConsumptionDTO dto16 = new PowerConsumptionDTO(16, 165D, 6.5, LocalDate.of(2022, 05, 15), 170D,
					"Advith", "GESCOM");
			PowerConsumptionDTO dto17 = new PowerConsumptionDTO(17, 187D, 6.8, LocalDate.of(2022, 05, 15), 175D,
					"Prokshith", "CESCOM");
			PowerConsumptionDTO dto18 = new PowerConsumptionDTO(18, 190D, 7.1, LocalDate.of(2022, 05, 15), 100D,
					"Pranav", "BESCOM");
			PowerConsumptionDTO dto19 = new PowerConsumptionDTO(19, 200D, 7.2, LocalDate.of(2022, 05, 15), 150D,
					"Prajwal", "HESCOM");
			PowerConsumptionDTO dto20 = new PowerConsumptionDTO(20, 234D, 8.1, LocalDate.of(2022, 05, 15), 100D,
					"Jaydeep", "MESCOM");
			PowerConsumptionDTO dto21 = new PowerConsumptionDTO(21, 143D, 6.3, LocalDate.of(2022, 05, 15), 150D,
					"Naveen", "CESCOM");
			PowerConsumptionDTO dto22 = new PowerConsumptionDTO(22, 178D, 7.2, LocalDate.of(2022, 05, 15), 175D,
					"Karan", "GESCOM");
			PowerConsumptionDTO dto23 = new PowerConsumptionDTO(23, 198D, 6.5, LocalDate.of(2022, 05, 15), 100D,
					"Sagar", "MESCOM");
			PowerConsumptionDTO dto24 = new PowerConsumptionDTO(24, 119D, 7.4, LocalDate.of(2022, 05, 15), 100D, "Ajay",
					"CESCOM");
			PowerConsumptionDTO dto25 = new PowerConsumptionDTO(25, 112D, 6.4, LocalDate.of(2022, 05, 15), 175D,
					"Mahima", "CESCOM");
			PowerConsumptionDTO[] name = { dto14, dto15, dto16, dto17, dto18, dto19, dto20, dto21, dto22, dto23, dto24,
					dto25 };
